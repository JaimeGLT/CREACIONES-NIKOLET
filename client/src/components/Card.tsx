...
const Card = ({url, nombre, description, precio, setState, id ,setCurrentProductId, setDeleteProductState}: CardProps) => {
    return (
        <div className="bg-white flex flex-col p-2 sm:p-4 rounded-4xl w-full max-w-[257px] gap-2 sm:gap-4">
            <div className='relative'>
                ...
                <img className='aspect-[3/4] rounded-t-4xl h-full w-full object-cover' src={url} alt={nombre} />
